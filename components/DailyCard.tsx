...
export default function DailyCard({ title, content, date }: DailyCardProps) {
  return (
    <div className="group relative rounded-2xl border border-emerald-200/60 bg-gradient-to-br from-white to-emerald-50/30 p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 overflow-hidden">
